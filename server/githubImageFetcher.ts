 ...
 */
export async function fetchShowcaseImage(username: string, repoName: string): Promise<ImageCheckResult> {
 ...
 */
export async function updateProjectsWithShowcaseImages(projects: any[]): Promise<any[]> {
